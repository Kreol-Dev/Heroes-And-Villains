...
public class Scribe
{
	...
	{
		console.Log (record, category, InternalMessage.MessageType.Notification);
	...
	{
		console.Log (record, category, InternalMessage.MessageType.Warning);
	...
	{
		console.Log (record, category, InternalMessage.MessageType.Error);
